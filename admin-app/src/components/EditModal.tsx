...
export const EditModal: React.FC<EditModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div
        className={`rounded-lg p-6 w-3/4 h-3/4 flex flex-col ${isDarkMode ? 'bg-gray-800 text-gray-100' : 'bg-white text-gray-900'}`}
      >
        ...
        {error && (
          <div
            className={`mb-4 p-3 rounded ${isDarkMode ? 'bg-red-500 bg-opacity-20 border border-red-500 text-red-500' : 'bg-red-100 border border-red-200 text-red-700'}`}
          >
